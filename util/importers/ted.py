...
def read_data_sets(data_dir, train_batch_size, dev_batch_size, test_batch_size, numcep, thread_count=8, limit_dev=0, limit_test=0, limit_train=0):
    ...
    # Create dev DataSet
    dev = _read_data_set(data_dir, TED_DIR, "dev", thread_count, dev_batch_size, numcep, limit=limit_dev)

    # Create test DataSet
    test = _read_data_set(data_dir, TED_DIR, "test", thread_count, test_batch_size, numcep, limit=limit_test)

    # Create train DataSet
    train = _read_data_set(data_dir, TED_DIR, "train", thread_count, train_batch_size, numcep, limit=limit_train)
...
def _read_data_set(data_dir, extracted_data, data_set, thread_count, batch_size, numcep, limit=0):
    # Create stm dir
